...
YouTubeChannelDetail *youtube_parse_channel_page(std::string url) {
	YouTubeChannelDetail *res = new YouTubeChannelDetail();
...
YouTubeChannelDetail *youtube_parse_channel_page(char *url) {
	std::string str(url);
	return youtube_parse_channel_page(str);
}

YouTubeChannelDetail *youtube_channel_page_continue(const YouTubeChannelDetail &prev_result) {
	YouTubeChannelDetail *new_result = new YouTubeChannelDetail(prev_result);
